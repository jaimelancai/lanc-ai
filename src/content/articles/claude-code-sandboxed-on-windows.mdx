...
The full technical narrative — every benchmark, every ruled-out approach, and the PowerShell landmines — is in the project's [ARCHITECTURE.md](https://github.com/jaimelancai/ClaudeCodeWSB/blob/main/docs/ARCHITECTURE.md). If you try the installer and something breaks, the [TROUBLESHOOTING.md](https://github.com/jaimelancai/ClaudeCodeWSB/blob/main/docs/TROUBLESHOOTING.md) covers the issues I hit during testing. I wrote up the full debugging journey separately: [Chasing a Two-Minute Freeze](/articles/chasing-a-two-minute-freeze).
